...
4. Respect `sql.max_rows`, `require_row_limit`, and `forbid_select_star` from config.
5. On reject, return result `failed` with concrete fixes. Do not execute invalid SQL.
